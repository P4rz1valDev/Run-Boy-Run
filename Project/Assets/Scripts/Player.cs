...
public class Player : MonoBehaviour
{
    ...
    public float _boostSpeed = 20f;
    public float _boostAcceleration = 100f;
    public bool _isBoosting = false;
    public float _normalMaxSpeed = 10f;
    public float _acceleration = 5f;
    public float _deceleration = 10f;
    public float _turnDeceleration = 35f;
    ...
    void Movement()
    {
        ...
        if (_isBoosting && horizontal != 0)
        {
            _currentSpeed = Mathf.MoveTowards(_currentSpeed, horizontal *  _boostSpeed, _boostAcceleration * Time.fixedDeltaTime);
        }
